...
from impact.v1.views import (
    ...
    ProgramListView,
    MarketingStartupListView,
    MarketingStartupProfileView,
...
v1_urlpatterns = [
    ...
    url(r"^startup_list_json_view/$",
        MarketingStartupListView.as_view(),
        name=MarketingStartupListView.view_name),
    url(r"^startup_list_json_view/(?P<program_key>[\w ]+)/$",
        MarketingStartupListView.as_view(),
        name=MarketingStartupListView.view_name),
    url(r"^startup_profile_json_view/$",
        MarketingStartupProfileView.as_view(),
        name=MarketingStartupProfileView.view_name),
