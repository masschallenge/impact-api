# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2018-01-30 09:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=500)),
                ('location', models.CharField(choices=[('MassChallenge Boston', 'MassChallenge Boston'), ('MassChallenge Israel - Jerusalem', 'MassChallenge Israel - Jerusalem'), ('MassChallenge Israel - Tel Aviv', 'MassChallenge Israel - Tel Aviv'), ('MassChallenge Switzerland', 'MassChallenge Switzerland'), ('MassChallenge Mexico', 'MassChallenge Mexico'), ('Pulse@MassChallenge', 'Pulse@MassChallenge'), ('Newton Innovation Center (NIC)', 'Newton Innovation Center (NIC)'), ('Remote', 'Remote')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(blank=True, null=True,
                                               on_delete=django.db.models.deletion.CASCADE, related_name='startups', to='impact.Currency')),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='impact.Organization')),
        ...
        migrations.AlterUniqueTogether(
            name='scenario',
            unique_together=set([('name', 'judging_round'), ('judging_round', 'sequence_number')]),
        ),
        migrations.AlterUniqueTogether(
            name='programstartupattribute',
